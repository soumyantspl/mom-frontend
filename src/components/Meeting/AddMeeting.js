...
const AddMeeting = (props) => {
  ...
  return (
    <div>
      {step == 1 ? (
        <div>
          <form className="mt-2 details-form" onSubmit={submitMeetingDetails}>
        ...
        <div>
          <form className="mt-2 details-form" onSubmit={submitAttendeeDetails}>
            <div className="inner-detail-form">
              ...
              <Button variant="primary" onClick={(e) => setStep(1)}>
                BACK
              </Button>
              <Button variant="primary" type="submit">
                NEXT
      ...
      <Collapse in={open}>
        <div id="example-collapse-text">
          ...
          <div className="form-group">
            <div className="row">
              <div className="col-md-4">
                <label className="mb-1">What are the topic to discuss ?</label>
              </div>
              <div className="col-md-8">
                <textarea
                  name=""
